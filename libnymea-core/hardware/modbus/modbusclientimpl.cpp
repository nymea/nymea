...
#include "modbusclientmanagerimpl.h"
#include "loggingcategories.h"

namespace nymeaserver {

/*! Construct the hardware resource ModbusClientManagerImpl with the given \a parent. */
ModbusClientManagerImpl::ModbusClientManagerImpl(QModbusClient *modbusClient, QObject *parent) :
    ModbusClientManager(parent),
...
QModbusReply *ModbusClientManagerImpl::get(const QModbusRequest &request)
{
