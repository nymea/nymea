...
class LIBNYMEA_EXPORT Action
{
    ...
    Q_PROPERTY(QString name READ name WRITE setName USER true) // TODO: make mandatory when deprecated actionTypeId is removed
...
public:
    ...
    explicit Action(const ThingId &thingId = ThingId(), const QString &name = QString(), TriggeredBy triggeredBy = TriggeredByUser);
